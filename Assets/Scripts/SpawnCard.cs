...
public class SpawnCard : MonoBehaviour
{
	...
	public static void CreateCard(GameObject cardPrefab, Transform transform, float xPos, float yPos, int handId)
	{
		...
		cardClone.transform.Find("CardDescription").gameObject.GetComponent<TextMesh>().text = card.Description.ToString().ToUpper();
		...
		cardClone.transform.localScale = new Vector3 (1.5F, 1.5F, 0.5F);
	}
}
